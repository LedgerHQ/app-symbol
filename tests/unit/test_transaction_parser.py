...
TESTS_CASES = {
    ...
    "create_mosaic.json": [
        ...
        (
            "Agg. Tx Hash",
            "E5F37FE3F83F4F0A2F21E7CF25F75CF29A20D7929CBEB7EB552EDA846969281F",
        ),
    ...
    "account_multisig.json": [
        ...
        (
            "Agg. Tx Hash",
            "043D6F6E851CAE4ED2B975AEEF61DFDF00B85BBB2503AC23DD7586E3C0B07956",
        ),
    ...
    "multisig_transfer_transaction.json": [
        ...
        (
            "Agg. Tx Hash",
            "4941C270B56778E01629FC82EDDC622668F076CE1583AFCCA3F6DE7FE03615BB",
        ),
    ...
    "multisig_create_mosaic.json": [
        ...
        (
            "Agg. Tx Hash",
            "705B456E99A2FA7DA3D4F02ABB1993774426B8095705C2116E6FB59E95A2587D",
        ),
        ("Inner TX Type", "Mosaic definition"),
    ...
    "multisig_create_namespace.json": [
        ...
        (
            "Agg. Tx Hash",
            "B96E1C08F8434BFDC4D1F292EB3F911B1A3C5B3EE102887A8ACDD75A79A4BB62",
        ),
    ...
    "cosignature_transaction.json": [
        ...
        (
            "Agg. Tx Hash",
            "0EFE6E4A881D312984767CABBE53DAC00419E179932A5C784B51132FBE5F7C88",
        ),
        ("Detail TX Type", "Transfer"),
        ("Recipient", "TDZKL2HAMOWRVEEF55NVCZ7C6GSWIXCI7IWAESI"),
        ("Amount", "10 XYM"),
    ...
    "account_metadata_transaction.json": [
        ...
        (
            "Agg. Tx Hash",
            "5F221AD2C6D297E683692CE332B24157057E6FB43A832F18C13495EC49544E08",
        ),
    ...
    "mosaic_metadata_transaction.json": [
        ...
        (
            "Agg. Tx Hash",
            "FD62E4D107693B6B0A7D862F2BBE49695565764AE41AE0D0344C47AE82DCB00C",
        ),
    ...
    "namespace_metadata_transaction.json": [
        ...
        (
            "Agg. Tx Hash",
            "668FE1351AC31C35536EE3A368F2C2310DD3D7E67A8345050548AE8B6596015D",
        ),
    ...
    "delegated_harvesting.json": [
        ...
        (
            "Agg. Tx Hash",
            "0C8666CEF61F61B78515149A1414455C77A0CCD7C9AD5F39DFE46761AB6556DF",
        ),
        ("Inner TX Type", "Account Key Link"),
        ("Action", "Link"),
        (
            "Linked Acct. PbK",
            "00278C080D6B149902E1576723DA6362065D3A134BEE6383827353540492B911",
        ),
        ("Inner TX Type", "Vrf Key Link"),
        ("Action", "Link"),
        (
            "Linked Vrf PbK",
            "C1A71431325873D83894977C68C783A4EED7A3391EAFD704BF8500361EC321DB",
        ),
        ("Inner TX Type", "Node Key Link"),
        ("Action", "Link"),
        (
            "Linked Node PbK",
            "81890592F960AAEBDA7612C8917FA9C267A845D78D74D4B3651AF093E6775001",
        ),
        ("Fee", "0.0432 XYM"),
    ],
    "persistent_harvesting_delegation_transfer.json": [
        ...
        (
            "Harvesting Message",
            "",
        ),
        ("Fee", "0.292 XYM"),
    ],
}
